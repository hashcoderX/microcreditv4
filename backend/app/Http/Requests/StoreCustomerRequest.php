...
class StoreCustomerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'old_nic' => ['nullable', 'string', 'max:60', 'unique:customers,old_nic'],
            'passport_no' => ['nullable', 'string', 'max:60', 'unique:customers,passport_no'],
            'driving_license_no' => ['nullable', 'string', 'max:60', 'unique:customers,driving_license_no'],
            'tax_identification_no' => ['nullable', 'string', 'max:60', 'unique:customers,tax_identification_no'],

...
Route::middleware(['auth:sanctum', 'system.online'])->group(function () {
    ...
    Route::get('reports/active-members', [AccountingReportsController::class, 'activeMembersReport']);
    ...
    Route::prefix('microfinance/loan-requests')->group(function () {
        ...
        Route::post('/{loanRequest}/direct-approve', [MicrofinanceLoanRequestController::class, 'directApprove']);
